...
export default function DepressionAdults() {
  ...
  const questionsData = [
    {
      id: 1,
      pageHeading: 'Depression Disorder Questionnaire for Adults',
    ...
    },
    {
      id: 4,
      pageHeading: 'Depression Disorder Questionnaire for Adults',
      questionHeading: '4. Feeling tired or having little energy ',
      redText: 'Symptoms during the past 7 days',
      options: [
        {text: 'Not at all', value: 'option 1'},
        {text: 'Several days', value: 'option 2'},
    ...
    },
    {
      id: 5,
      pageHeading: 'Depression Disorder Questionnaire for Adults',
      questionHeading: '5. Poor appetite or overeating',
      redText: 'Symptoms during the past 7 days',
      options: [
        {text: 'Not at all', value: 'option 1'},
        {text: 'Several days', value: 'option 2'},
